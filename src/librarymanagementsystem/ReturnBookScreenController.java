 ...
 * @author grewal
 */
public class ReturnBookScreenController implements Initializable {
...
public void LoadDrawer(String s) {
    ...
    private void displayBookStatus() throws SQLException, ClassNotFoundException, ParseException {
        ...
        java.util.Date dueDate = formatter.parse(date);
                ...
                status.setText("Book is Returned but Overdue");
                }
        ...
        Boolean bookExists = false;
        Connection connection = DatabaseConnection.createConnection();
        String query = "SELECT * FROM Issue WHERE bookId = '" + bookId +"'" + "AND userId = '" +userId + "'";
